...
namespace AppMvc.Controllers
{
    ...
    public class AlunosController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,NomeCompleto,Email,CPF,Descricao,Ativo")] Aluno aluno)
        {
        ...
        [Route("editar-aluno/{id:int}")]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,NomeCompleto,Email,CPF,Descricao,Ativo")] Aluno aluno)
        {
            if (ModelState.IsValid)
            {
                ...
                TempData["Mensagem"] = "Dados alterado com sucesso!";
